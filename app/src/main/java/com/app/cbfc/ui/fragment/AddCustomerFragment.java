...
public class AddCustomerFragment extends Fragment {
    ...
    View view;
    @BindView(R.id.cus_full_name)
    EditText etFullName;
    @BindView(R.id.cus_father_name)
    EditText etFatherName;
    @BindView(R.id.cus_mobile)
    EditText etMobile;
    @BindView(R.id.cus_address)
    EditText etAddress;
    @BindView(R.id.cus_adhar_card_number)
    EditText etAdharCardNumber;
    @BindView(R.id.cus_pan_card_number)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //((AdminDashboard)getActivity()).updateFragment(new UploadCustomberDocumnet(),"Upload Document");
    ...
    private void addCustomber(){
        APIRequest service = APIClient.getInstance();
        service.addCustomer("5",
